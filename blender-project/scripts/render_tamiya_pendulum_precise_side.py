"""Load the precise Tamiya pendulum assembly and render a side orthographic PNG."""

import bpy
import math

BLEND_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise.blend"
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise_preview_side.png"
...
print(f"Rendered precise side preview: {OUTPUT_PATH}")
