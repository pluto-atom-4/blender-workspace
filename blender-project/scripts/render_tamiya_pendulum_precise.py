"""Load the precise Tamiya pendulum assembly and render a 3/4 preview PNG."""

import bpy
import math

BLEND_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise.blend"
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise_preview.png"
...
print(f"Rendered precise 3/4 preview: {OUTPUT_PATH}")
