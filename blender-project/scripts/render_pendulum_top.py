"""Load the built armed inverted pendulum assembly and render a top-down
...
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/pendulum_preview_top.png"
...
# Top-down, looking along -Z at the X-Y plane.
bpy.ops.object.camera_add(location=(0.0, 0.0, 650.0))
camera = bpy.context.active_object
camera.name = "Preview_Camera_Top"
camera.data.type = 'ORTHO'
camera.data.ortho_scale = 310.0
...
bpy.ops.object.light_add(type='SUN', location=(300.0, -300.0, 600.0))
sun = bpy.context.active_object
sun.data.energy = 3.5
sun.rotation_euler = (math.radians(15.0), 0.0, math.radians(45.0))

bpy.ops.object.light_add(type='AREA', location=(-300.0, 300.0, 500.0))
...
print(f"Rendered top preview: {OUTPUT_PATH}")
