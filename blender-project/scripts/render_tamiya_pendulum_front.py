"""Load the built Tamiya pendulum assembly and render a front orthographic PNG."""

import bpy
import math

BLEND_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum.blend"
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_preview_front.png"
...
# Camera: orthographic front elevation, looking along -Y at the X-Z plane.
...
# Angled sun + fill light so the flat front elevation still reads in 3D.
