"""Load the precise servo-driven Tamiya pendulum assembly and render a side orthographic PNG."""

import bpy
import math

BLEND_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_servo_precise.blend"
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_servo_precise_preview_side.png"
...
print(f"Rendered servo-precise side preview: {OUTPUT_PATH}")
