"""Load the built armed inverted pendulum assembly and render a front
...
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/pendulum_preview_front.png"
...
# Front elevation, looking along -Y at the X-Z plane.
bpy.ops.object.camera_add(location=(0.0, -700.0, TARGET[2]))
...
bpy.ops.object.light_add(type='SUN', location=(300.0, -400.0, 500.0))
...
print(f"Rendered front preview: {OUTPUT_PATH}")
