"""Load the precise Tamiya pendulum assembly and render a top-down preview PNG."""

import bpy

BLEND_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise.blend"
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise_preview_top.png"
...
print(f"Rendered precise top-down preview: {OUTPUT_PATH}")
