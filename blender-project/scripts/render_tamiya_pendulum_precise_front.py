"""Load the precise Tamiya pendulum assembly and render a front orthographic PNG."""

import bpy
import math

BLEND_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise.blend"
OUTPUT_PATH = "/home/pluto-atom-4/blender-workspace/blender-project/renders/tamiya_pendulum_precise_preview_front.png"
...
print(f"Rendered precise front preview: {OUTPUT_PATH}")
