Write a github issue to crate a 3D model with animation

- Utilize the Blender local agent 
- Build a 3D model as same qulity as the 'tamiya_pendulum_servo_studio.blend'
- Simulate same behavior by migrating the python script in the code block.
- create an issue using here doc like $(cat EOF << .... )

Reference:

- blender-project/renders/tamiya_pendulum_servo_studio.blend
- Github Issue #2
##
